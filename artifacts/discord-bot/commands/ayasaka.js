...
function buildContainers() {
  ...
  const resumo = new ContainerBuilder()
    ...
    .addTextDisplayComponents(txt(
      `-# ⚔️ Oblivion League · Line Ayasaka · Atualizado em ${new Date().toLocaleDateString('pt-BR')}`
    ));
...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('ayasaka')
    .setDescription('Tabela de resultados da Line Ayasaka em X-Treinos e torneios')
        ...
        components: [
          new ContainerBuilder()
            ...
            .addTextDisplayComponents(txt(
              ...
              `-# ${RESULTADOS.length} resultado${RESULTADOS.length !== 1 ? 's' : ''} · Line Ayasaka · Oblivion League`
            )),
        ],
